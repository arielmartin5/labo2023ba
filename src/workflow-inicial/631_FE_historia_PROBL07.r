...
PARAM <- list()
PARAM$experimento <- "FE6310_PROBL07"

PARAM$exp_input <- "DR6210_PROBL07"
...
PARAM$RandomForest$semilla <- 125541 # cambiar por la propia semilla
...
PARAM$CanaritosAsesinos$semilla <- 125541
