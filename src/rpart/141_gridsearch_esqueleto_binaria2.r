...
PARAM$semillas <- c(101666, 124541, 196666, 106666, 166666)
...
archivo_salida <- "./exp/HT2020/gridsearch__binaria2_001.txt"
...
for (vcp in c(-1, -0.5)) {
    for (vmax_depth in c(7, 8, 10, 12, 14, 16)) {
        for (vmin_split in c(1200, 1000, 800, 600, 500, 400, 250)) {
