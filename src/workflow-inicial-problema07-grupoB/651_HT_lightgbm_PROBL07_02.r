...
# Optimización Bayesiana para Problema 7 - Grupo B - Experimento 02
...
PARAM <- list()
PARAM$experimento <- "HT6510_PROBL07_02"

PARAM$exp_input <- "TS6410_PROBL07_02"

# En caso que se haga cross validation, se usa esta cantidad de folds
PARAM$lgb_crossvalidation_folds <- 20

PARAM$lgb_semilla <- 125541 # cambiar por su propia semilla
