...
# Este script establece la estrategia de testing con los meses de pandemia que van
...
PARAM <- list()
PARAM$experimento <- "TS6410_PROBL07_02"
...
# Entreno en 18 meses, considerando los meses de pandemia
PARAM$train$training <- c(
  202103, 202102, 202101, 202012, 202011, 202010, 202009, 202008, 202007, 
  202006, 202005, 202004, 202003, 202002, 202001, 201912, 201911, 201910
)
