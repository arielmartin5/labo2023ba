...
PARAM <- list()
PARAM$experimento <- "ZZ6610_PROBL07_01"
PARAM$exp_input <- "HT6510_PROBL07_01"
...
PARAM$semillas <- c(125541, 703127, 711195, 986177, 500153, 101666, 
                    136713, 143821, 123457, 176613)
