...
# desde 202003 a 202007. Se entrena en 18 meses, manteniendo siempre fija esta ventana
...
PARAM <- list()
PARAM$experimento <- "TS6410_PROBL07_00"
...
# Entreno en 18 meses, sin considerar los meses de pandemia desde 202003 a 202007
PARAM$train$training <- c(
  202103, 202102, 202101, 202012, 202011, 202010, 202009, 202008, 202002,
  202001, 201912, 201911, 201910, 201909, 201908, 201907, 201906, 201905
)
